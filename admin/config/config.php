...
$config['xurl'] = $xurl;
$config['xkey'] = 'eyeback:superb4cksm4rt3r';

/*
|--------------------------------------------------------------------------
| Folder Theme Backend
|--------------------------------------------------------------------------
*/
$config['base_theme'] = 'dreampro';
...
$path = ($_SERVER['SERVER_NAME'] == 'localhost') ? '/project/aplikasi/eyesoccer/liveeye/lab.eyesoccer.id' : '';
$www = ($link[0] != 'www') ? '' : 'www.';
...
|
*/
$config['encryption_key'] = 'p1o2i3u4y5q0w9e8r7t6';
