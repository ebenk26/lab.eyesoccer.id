...
<div id='boxbutton'> 
    ...
    <div class='search'>
        ...
        <select name='cselect' class='cinput inselect'>
            <?php
                $field = array('search' => 'Title', 'note' => 'Category');
        ...
        <input type='text' name='csearch' class='cinput insearch' value='<?php echo $csearch; ?>' placeholder='Search...' onkeyup="actsearch('advert/search')">
    </div>
...
<div id='boxaction'>
    ...
    <a href="javascript:void(0)" id='button' onclick="actcheck('advert/checked')">Action</a>
    
    <div class='limit'>
        <label>Limit</label>
        <select name='climit' class='climit inselect' onchange="actlimit('advert/view')">
            <?php
