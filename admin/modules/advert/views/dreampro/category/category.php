...
<div id='boxbutton'>
    <?php
        ...
        if(isset($_GET['id']))
        {
            ?> <a href="javascript:void(0)" id='button' onclick="actmenu('advert/category/view<?php echo $sv->idback; ?>')">Back</a> <?php
        }
    ?>
    <a href="javascript:void(0)" id='button' onclick="openform('advert/category/add<?php echo $sv->idstay; ?>')">Add New</a>
    ...
    <div class='search'>
        ...
        <input type='text' name='csearch' class='cinput insearch' value='<?php echo $csearch; ?>' placeholder='Search...' onkeyup="actsearch('advert/category/search<?php echo $sv->idstay; ?>')">
    </div>
    ...
    <?php
        if($showpage > 1)
        {
            echo "<div id='pageself'>
                    <div id='showurl' value='advert/category/pagetable".$sv->idstay."'></div>
