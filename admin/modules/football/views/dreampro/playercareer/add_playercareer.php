...
<div id='boxjq'>
    ...
    <?php echo form_open_multipart('football/playercareer/save'.$sv->idstay, array('name' => 'form_addmulti', 'id' => 'form_addmulti')); ?>
            ...
            <div class='col-lg-8 col-md-12 col-sm-8 col-xs-12'>
                <div class='boxtab pad-all mg-b20'>
                    ...
                    <div class='pad-lr20'>
                        ...
                        <div class='mg-b10'>
                            <label>Club</label>
                            <input type='text' name='club' id='club' class='cinput input_multi' required>
                        </div>
						<div class='mg-b10'>
						...
						<div class='mg-b10'>
                            ...
                            <input type='number' name='number_of_play' id='number_of_play' class='cinput input_multi'>
                        </div>
                        <div class='mg-b10'>
                            <label>Back Number</label>
                            <input type='number' name='back_number' id='back_number' class='cinput input_multi'>
                        </div>
						<div class='pad-b20'>
                            <label>Coach</label>
                ...
                <div class='boxtab pad-all mg-b20'>
                    ...
                    <div class='pad-lr20'>
                        ...
                        <div class='pad-b18'>
                            <div class='layout-row'>
                                <span class='flex'></span>
                                <input type='submit' value='Save' id='btn_submit' onclick="saveaddmulti('football/playercareer/save<?= $sv->idstay; ?>')">
                            </div>
                        </div>
                    </div>
                </div>
