...
<div id='boxjq'>
    ...
    <?php echo form_open_multipart('football/playerachieve/update'.$sv->idstay, array('name' => 'form_addmulti', 'id' => 'form_addmulti')); ?>
            ...
            <div class='col-lg-8 col-md-12 col-sm-8 col-xs-12'>
                <div class='boxtab pad-all mg-b20'>
                    ...
                    <div class='pad-lr20'>
                        ...
                        <input type='hidden' name='idx' value='<?php echo $dt1->id_achievement?>'>
						...
						<div class='pad-b20'>
                            ...
                            <input type='text' name='appreciation' id='appreciation' class='cinput input_multi' value="<?php echo $dt1->appreciation; ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class='pad-lr20'>
                        <div class='pad-b18'>
                            <div class='layout-row'>
							    ...
							    <input type='submit' value='Save' id='btn_submit' onclick="saveaddmulti('football/playerachieve/update<?= $sv->idstay; ?>')">
                            </div>
                        </div>
                    </div>
                </div>
