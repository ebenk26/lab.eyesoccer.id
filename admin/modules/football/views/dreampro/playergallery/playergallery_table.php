<table id='routertable'>
    <tr>
        ...
        <div id='showsort' value='football/playergallery/search<?php echo $sv->idstay; ?>'></div>
        <th style='width: 5%;'>
    ...
    if($count->cc > 0)
    {
        ...
        foreach($dt as $r)
        {
            ...
            echo "<td class='center'>
                    <a class='btn_action' href='javascript:void(0)' onclick=\"deleteid('football/playergallery/delete/". $r->id_gallery  . $sv->idstay ."')\" title='Remove'><i class='fa fa-minus-square fa-fw'></i></a>
                 </td>";
            echo "</tr>";
