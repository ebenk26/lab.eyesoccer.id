...
<div id='boxjq'>
    <div id='boxbutton'>
        ...
        <a href="javascript:void(0)" id='button' onclick="actmenu('football/playergallery/view<?php echo $sv->idstay; ?>')">Back</a>
        
        <div style='clear: both;'></div>
    </div>
    
    <?php echo form_open_multipart('football/playergallery/save'.$sv->idstay, array('name' => 'form_addmulti', 'id' => 'form_addmulti')); ?>
                    ...
                    <div class='pad-lr20'>
                        <div class='pad-b18'>
                            <div class='layout-row'>
                                ...
                                <input type='submit' value='Save' id='btn_submit' onclick="saveaddmulti('football/playergallery/save<?= $sv->idstay; ?>')">
                            </div>
                        </div>
                    </div>
                </div>
