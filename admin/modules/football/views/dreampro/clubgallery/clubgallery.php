...
<?php
    ...
    $this->load->view($this->config->item('base_theme').'/club/club_header', ['tab' => 'gallery']);
?>

<div id='boxbutton'> 
    <a href="javascript:void(0)" id='button' onclick="openform('football/clubgallery/add<?php echo $sv->idstay; ?>')">Add New</a>
...
<div id='boxaction'>
    ...
    <a href="javascript:void(0)" id='button' onclick="actcheck('football/clubgallery/checked', '<?php echo $sv->idstay; ?>')">Action</a>
    
    <div class='limit'>
        <label>Limit</label>
        <select name='climit' class='climit inselect' onchange="actlimit('football/clubgallery/view<?php echo $sv->idstay; ?>')">
            <?php
...
<div id='boxjq'>
    <div id='boxtable'>
        <?php $this->load->view($this->config->item('base_theme').'/clubgallery/clubgallery_table'); ?>
    </div>
    ...
    <?php
        if($showpage > 1)
        {
            echo "<div id='pageself'>
                    <div id='showurl' value='football/clubgallery/pagetable".$sv->idstay."'></div>
