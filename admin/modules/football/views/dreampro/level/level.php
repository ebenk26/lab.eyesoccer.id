...
<div id='boxbutton'>
    <?php
        ...
        {
            ?> <a href="javascript:void(0)" id='button' onclick="actmenu('football/level/view<?php echo $sv->idback; ?>')">Back</a> <?php
        }
    ?>
    <a href="javascript:void(0)" id='button' onclick="openform('football/level/add')">Add New</a>
    
    <div class='search'>
        <label>Search By</label>
        <select name='cselect' class='cinput inselect'>
            <?php
                $field =array('level' => 'Name level');
        ...
        <input type='text' name='csearch' class='cinput insearch' value='<?php echo $csearch; ?>' placeholder='Search...' onkeyup="actsearch('football/level/search')">
    </div>
...
<div id='boxaction'>
    ...
    <a href="javascript:void(0)" id='button' onclick="actcheck('level/checked')">Action</a>
...
<div id='boxjq'>
    <div id='boxtable'>
        <?php $this->load->view($this->config->item('base_theme').'/level/level_table'); ?>
    </div>
    ...
    <?php
        if($showpage > 1)
        {
            echo "<div id='pageself'>
                    <div id='showurl' value='football/level/pagetable'></div>
