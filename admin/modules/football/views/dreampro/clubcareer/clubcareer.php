...
<div id='boxaction'>
    ...
    <a href="javascript:void(0)" id='button' onclick="actcheck('football/clubcareer/checked', '<?php echo $sv->idstay; ?>')">Action</a>
    
    <div class='limit'>
        <label>Limit</label>
        <select name='climit' class='climit inselect' onchange="actlimit('football/clubcareer/view<?php echo $sv->idstay; ?>')">
            <?php
...
<div id='boxjq'>
    <div id='boxtable'>
        <?php $this->load->view($this->config->item('base_theme').'/clubcareer/clubcareer_table'); ?>
    </div>
