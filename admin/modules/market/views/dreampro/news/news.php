...
<div id='boxbutton'> 
    <a href="javascript:void(0)" id='button' onclick="openform('news/add')">Add New</a>
    ...
    <div class='search'>
        ...
        <input type='text' name='csearch' class='cinput insearch' value='<?php echo $csearch; ?>' placeholder='Search...' onkeyup="actsearch('news/search')">
    </div>
