            ...
            <div class='col-lg-8 col-md-12 col-sm-8 col-xs-12'>
                <div class='boxtab pad-all mg-b20'>
                    ...
                    <div class='pad-lr20'>
                        ...
                        <div class='mg-b10'>
                            <label>Name</label>
                            <input type='text' name='language_name' id='country_name_100' class='cinput input_multi'
                        ...
                        <div class='pad-b20' id='table_language'>
                            ...
                            <input type='text' name='lang_code' id='language_code_99' class='cinput input_multi'
                    ...
                    <div class='pad-lr20'>
                        <div class='pad-b18'>
                            ...
                            <div class='layout-row'>
                                ...
                                <input type='submit' value='Save' id='btn_submit' onclick="saveadd('system/language/update')">
                            </div>
                        </div>
                    </div>
                </div>
