...
<div id='boxbutton'> 
    <a href="javascript:void(0)" id='button' onclick="openform('system/language/add')">Add New</a>
    
    <div class='search'>
        <label>Search By</label>
        <select name='cselect' class='cinput inselect'>
            <?php
                $field = array('language_name' => 'Name', 'is_active' => 'Active');
        ...
        <input type='text' name='csearch' class='cinput insearch' placeholder='Search...' onkeyup="actsearch('system/language/search')">
    </div>
...
<div id='boxaction'>
    <div class='action'>
        <select name='caction' class='caction inselect'>
            ...
            <?php
                $sort = array('Delete' => '1', 'Default' => '2', 'Enabled' => '3', 'Disabled' => '4');
    ...
    <a href="javascript:void(0)" id='button' onclick="actcheck('system/language/checked')">Action</a>
    
    <div class='limit'>
        <label>Limit</label>
        <select name='climit' class='climit inselect' onchange="actlimit('system/language/view')">
            <?php
