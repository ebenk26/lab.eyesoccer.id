...
<div id='boxbutton'>
    <?php
        ...
        {
            echo "<a href='javascript:void(0)' id='button' onclick='openform(\"system/user/add\")'>Add New</a>";    
        }
    ?>
    ...
    <div class='search'>
        ...
        <select name='cselect' class='cinput inselect'>
            <?php
                $field = array('user_name' => 'Username', 'user_fname' => 'Fullname', 'is_active' => 'Active');
        ...
        <input type='text' name='csearch' class='cinput insearch' value='<?php echo $csearch; ?>' placeholder='Search...' onkeyup="actsearch('system/user/search')">
    </div>
...
?>
        <div id='boxaction'>
            ...
            <a href="javascript:void(0)" id='button' onclick="actcheck('system/user/checked')">Action</a>
            
            <div class='limit'>
                <label>Limit</label>
                <select name='climit' class='climit inselect' onchange="actlimit('system/user/view')">
                    <?php
...
<div id='boxjq'>
    <div id='boxtable'>
        <?php $this->load->view($this->config->item('base_theme').'/user/user_table'); ?>
    </div>
    ...
    <?php
        if($showpage > 1)
        {
            echo "<div id='pageself'>
                    <div id='showurl' value='system/user/pagetable'></div>
