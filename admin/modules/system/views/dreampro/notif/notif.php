...
<div id='boxbutton'> 
    <a href="javascript:void(0)" id='button' onclick="openform('system/notif/add')">Add New</a>
    
    <div class='search'>
        <label>Search By</label>
        <select name='cselect' class='cinput inselect'>
            <?php
                $field = array('notif_name' => 'Subject', 'notif_type' => 'Type', 'is_active' => 'Active');
        ...
        <input type='text' name='csearch' class='cinput insearch' value='<?php echo $csearch; ?>' placeholder='Search...' onkeyup="actsearch('system/notif/search')">
    </div>
...
<div id='boxaction'>
    ...
    <a href="javascript:void(0)" id='button' onclick="actcheck('system/notif/checked')">Action</a>
    
    <div class='limit'>
        <label>Limit</label>
        <select name='climit' class='climit inselect' onchange="actlimit('system/notif/view')">
            <?php
...
<div id='boxjq'>
    <div id='boxtable'>
        <?php $this->load->view($this->config->item('base_theme').'/notif/notif_table'); ?>
    </div>
    ...
    <?php
        if($showpage > 1)
        {
            echo "<div id='pageself'>
                    <div id='showurl' value='system/notif/pagetable'></div>
