...
<div id='boxjq'>
    ...
    <?php echo form_open_multipart('video/save', array('name' => 'form_addmulti', 'id' => 'form_addmulti')); ?>
                    ...
                    <div class='pad-lr20'>
                        <div class='pad-b18'>
                            ...
                            <div class='layout-row'>
                                ...
                                <input type='submit' value='Save' id='btn_submit' onclick="saveaddmulti('video/save')">
                            </div>
                        </div>
                    </div>
                </div>
