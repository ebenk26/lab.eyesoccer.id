...
_.setTitle = function(title) {
    ...
    if (_.opener.name == "tinymce")
        ...
        var ifr = $('iframe[src*="?opener=tinymce4&"]', window.parent.document),
            path = ifr.attr('src').split('?')[0];
...
_.maximize = function(button) {
    ...
    if (_.opener.name == "tinymce") {
        ...
        var par = window.parent.document,
            ...
            ifr = $('iframe[src*="?opener=tinymce&"]', par),
    ...
    // TINYMCE 4
        ...
        var par = window.parent.document,
            ...
            ifr = $('iframe[src*="?opener=tinymce4&"]', par).parent(),
            win = ifr.parent();
...
_.baseGetData = function(act) {
    ...
    var data = "?type=" + encodeURIComponent(_.type) + "&lng=" + _.lang;
    if (act)
        data += "&act=" + act;
    if (_.cms)
        data += "&cms=" + _.cms;
